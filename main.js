...
let akses = true;
  ...
  generateHighQualityLinkPreview: true, 
    ...
    async function connectionUpdate(_0x1252c2) {
      const {
        connection: _0x17edae,
        lastDisconnect: _0x5bccf4,
        isNewLogin: _0x53b03c
      } = _0x1252c2;
      global.stopped = _0x17edae;
      if (_0x53b03c) {
        conn.isInit = true;
      }
      const _0xb045f5 = _0x5bccf4?.["error"]?.["output"]?.["statusCode"] || _0x5bccf4?.["error"]?.["output"]?.["payload"]?.["statusCode"];
      if (_0xb045f5 && _0xb045f5 !== DisconnectReason.loggedOut && conn?.[ws]["readyState"] !== _0x2635aa["default"].CONNECTING) {
      ...
      if (_0x17edae === "open") {
        const _0x47a596 = _0x20e23d.hostname();
        const _0x2cd12e = "• *Info*: Bot telah aktif\n◦ *Os*: " + _0x20e23d.platform() + " " + _0x20e23d.release() + "\n◦ *Device*: " + _0x47a596 + "\n◦ *NameBot*: " + global.namebot + "\n◦ *Connected time*: " + new Date().toLocaleString();
        const _0x10b56a = {
          text: _0x2cd12e
        };
        this.sendMessage(global.nomerown + "@s.whatsapp.net", _0x10b56a);
         
        console.log(_0x1ffd2b.bgGreen(_0x1ffd2b.white("Bot sudah aktif")));
      }
      if (_0x17edae == "close") {
        console.log(_0x1ffd2b.yellow("📡 Koneksi terputus dari server, hapus sessions dan segera ambil ulang ⚠️"));
      }
    }
